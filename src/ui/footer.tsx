        ...
        <div>
          ...
          <div class="mt-5">
            <a
              ...
              class="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:opacity-90 active:scale-95"
              style="background:linear-gradient(135deg,#B04040,#e07070);"
            >
              {locale === "fa" ? "از ما حمایت کنید · یاور" : "Support Us · Yavar"}
            </a>
          </div>
        </div>
        <div>
