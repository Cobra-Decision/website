...
export const COMMON_EMAIL_PLACEHOLDERS: PlaceholderDef[] = [
  ...
  { tag: "{{meet_title_encoded}}", label: "+ meet_title_encoded" },
  ...
  { tag: "{{meet_start_utc}}", label: "+ meet_start_utc" },
  { tag: "{{meet_end_utc}}", label: "+ meet_end_utc" },
  { tag: "{{meet_start_iso}}", label: "+ meet_start_iso" },
  { tag: "{{meet_end_iso}}", label: "+ meet_end_iso" },
  { tag: "{{presenter_name}}", label: "+ presenter_name" },
  { tag: "{{meet_link}}", label: "+ meet_link" },
  { tag: "{{meet_link_encoded}}", label: "+ meet_link_encoded" },
  { tag: "{{tags}}", label: "+ tags" },
  { tag: "{{otp}}", label: "+ otp" },
